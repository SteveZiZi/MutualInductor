...
///     控件的背景颜色
///
#define WFG_CTRL_BKGND_COLOR    qRgb(40,49,65)            ///< 黑色

///
/// @brief
///     字体的默认设置，包括字体样式以及标题、X-Y标尺刻度、波形描述信息和游标描述信息的字体大小和颜色
///
#define WFG_FONT_STYLE             "simsun"
#define WFG_TITLE_FONT_SIZE        12
#define WFG_TITLE_FONT_COLOR       qRgb(0,0,0)      ///< 白色
#define WFG_SCALE_FONT_SIZE        12
#define WFG_SCALE_FONT_COLOR       qRgb(0,0,0)      ///< 暖灰色
#define WFG_WAVEDESC_FONT_SIZE     15
#define WFG_CURSORDESC_FONT_SIZE   12
